...
export class coveredMap {
    constructor(debugText = null, debugColor = null) {
        ...
        this.isCovered = function () {
            ...
            let points = [];
            points.push(getPointFromCamera(canvas.clientWidth * 0.3, canvas.clientHeight * 0.3))
            points.push(getPointFromCamera(canvas.clientWidth * 0.3, canvas.clientHeight * 0.6))
            points.push(getPointFromCamera(canvas.clientWidth * 0.6, canvas.clientHeight * 0.3))
            points.push(getPointFromCamera(canvas.clientWidth * 0.6, canvas.clientHeight * 0.6))
            ...
            if (!isInside) {
                ...
                let radius = Cesium.Cartesian3.distance(camera.positionWC, viewCenter) / 1.8
                ...
                if (this.debugColor) {
                    ...
                    /// draw debug point
                    var debugPoint = viewer.entities.add({
